...
import { CheckCircle, ArrowLeft, Star, Trophy, Shield } from 'lucide-react';
...
const ClosedBetaDemo = () => {
  ...
  // Fallback component for non-superadmin users
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl font-bold tracking-tight sm:text-5xl mb-4">
                Accès <span className="rainbow-text-static">temporairement restreint</span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                chyll est actuellement en développement et l'accès à la liste d'attente est 
                temporairement limité pendant cette phase de test.
              </p>
            </div>
            ...
            <Card className="border-2 border-orange-200 shadow-lg">
              <CardHeader className="text-center pb-6">
                ...
                <CardTitle className="text-2xl">Phase de développement</CardTitle>
                <p className="text-muted-foreground mt-2">
                  Nous finalisons les derniers détails de notre plateforme
                </p>
              </CardHeader>
              
              <CardContent className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-4">Ce qui vous attend bientôt :</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Liste d'attente gamifiée</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Système de parrainage</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                <div className="bg-muted/50 rounded-lg p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Suivez-nous pour être notifié dès l'ouverture de la liste d'attente
                  </p>
                  <div className="flex justify-center gap-4">
                    <Button variant="outline" size="sm" asChild>
                      <a href="https://linkedin.com/company/chyll-ai" target="_blank" rel="noopener noreferrer">
                        LinkedIn
                      </a>
                    </Button>
                    <Button variant="outline" size="sm" asChild>
                      <a href="https://twitter.com/chyll_ai" target="_blank" rel="noopener noreferrer">
                        Twitter
                      </a>
                    </Button>
                  </div>
  ...
  return (
    <SuperadminGuard fallback={AccessDeniedFallback}>
      <div className="flex min-h-screen flex-col">
        <Header />
