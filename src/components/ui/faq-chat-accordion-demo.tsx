...
function DefaultDemo() {
  const faqData = [
    {
      answer: "chyll utilise l'intelligence artificielle conversationnelle pour comprendre vos demandes en langage naturel. Dites simplement ce que vous voulez : 'Trouve des prospects dans la tech' ou 'Enrichis ces leads', et chyll exécute instantanément.",
      icon: "🤖",
  ...
  return (
    <FaqAccordion 
      ...
      timestamp="Dernière mise à jour : Juin 2025"
    />
  );
}
...
function CustomStyleDemo() {
  const faqData = [
    {
      answer: "chyll is the future of CRM - a conversational AI that understands natural language. Simply tell chyll what you need: 'Find tech prospects in Paris' or 'Enrich these leads', and it executes instantly without complex interfaces.",
      icon: "🤖",
      iconPosition: "right" as const,
      id: 1,
