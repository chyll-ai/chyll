...
-- Fix the referral code generation to use base64 instead of base64url
ALTER TABLE public.waitlist 
ALTER COLUMN referral_code 
SET DEFAULT encode(gen_random_bytes(8), 'base64');

-- Update the handle_waitlist_signup function to ensure it works with the new encoding
